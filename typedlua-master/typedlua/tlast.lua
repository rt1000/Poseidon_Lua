...
-- statStruct : (number, string, type) -> (stat)
function tlast.statStruct (pos, name, t)
	t.struct = name
	t.structInfo = {}
	...
	for _, v in ipairs(t) do
		...
		t.structInfo.offsetTable[ keyString ] = t.structInfo.size
		t.structInfo.size = t.structInfo.size + valueSize
	end --end for

	return tlast.statInterface( pos, name, t )
