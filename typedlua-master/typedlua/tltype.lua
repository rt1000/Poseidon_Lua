...
-- C_char : () -> (type)
function tltype.C_char ()
  return tltype.C_BaseType("char")
end
-- C_int : () -> (type)
function tltype.C_int ()
  return tltype.C_BaseType("int")
end
-- C_double : () -> (type)
...
function tltype.is_C_array (t)
  return t.tag == "T_C_array"
end
