...
void luaV_execute (lua_State *L) {
 ...
 newframe:  /* reentry point when frame changes (call/return) */
  ...
  for (;;) {
	...
	const char *indexString = lua_tolstring( L, -1, NULL ) ;
	int tableIndex = atoi( indexString ) ;
	...
	int *resultInt = &(foo1->sum) ;
	resultInt = resultInt + tableIndex ;


	//PUSH "RESULT_SUM" INTO THE GLOBAL "arg" TABLE:
	lua_pushstring( L, "RESULT_SUM" ) ;
